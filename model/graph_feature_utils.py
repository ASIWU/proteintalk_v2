...
def _cache_matches(feature_path: Path, meta_path: Path, expected: dict[str, Any]) -> dict[str, Any] | None:
...
def build_or_load_graph_features(
    *,
    ...
    with _exclusive_file_lock(lock_path):
        ...
        _atomic_save_npy(feature_path, graph_features.astype(np.float32))
