...
METHODS="${METHODS:-teacher_b1_g2_w01_s01 teacher_b075_g2_w01_s01 teacher_z_b075_g2_w01_s01 teacher_b075_g2_w05_s01 teacher_b075_g2_w01_s05 exprdrop010 exprdrop020 exprdrop030 exprdrop020_learn_b075 learn_delta_b1_g2_init01 learn_delta_b1_g2_init025 learn_delta_b075_g2_init01 learn_zdelta_b075_g2_init01 zdelta_b0_g0_dim32 zdelta_b0_g05_dim32 zdelta_b025_g05_dim32 zdelta_b05_g1_dim64 zdelta_b075_g2_dim64 zdelta_b05_g2_dim64 delta512_b0_g0_d1_w1 delta512_b0_g05_d1_w1 delta512_b025_g05_d1_w1 delta256_b05_g1_d1_w1 delta512_b05_g2_d1_w1 pretrain_base3 pretrain_base5_bce02 pretrain_delta_b1_g2_d05_pre3 pretrain_delta_b075_g2_d1_pre3 pretrain_delta_b05_g2_d1_pre3 pretrain_bridge_b05_g1_d1_pre5 bridge_b0_g0_d1_dim16 bridge_b0_g0_d1_dim32 bridge_b0_g05_d1_dim32 bridge_b025_g05_d1_dim32 bridge_b0_g1_d2_dim64 bridge_pdi_b0_g05_d1 bridge_pdippi_b0_g05_d1 mse_target_pdi mse_target_pdi_w05 mse_target_pdippi_w05 delta_summary_all01_dim16 delta_summary_all025_dim16 delta_summary_all025_dim32 delta_summary_all025 delta_summary_all05 delta_gate_all05 delta_summary_pdi delta_gate_pdi delta_summary_pdippi_sched topvar_pdi_sched}"
  ...
  case "${method}" in
    teacher_b1_g2_w01_s01)
      method_env=(
        ...
        DELTA_TEACHER_LOSS_WEIGHT=0.1
        GRAPH_LOGIT_SCALE=2.0
        MSE_WEIGHT=0.25
      )
      ;;
    teacher_b075_g2_w01_s01)
      method_env=(
        RESPONSE_BASE_LOGIT_SCALE=0.75
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=64
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=0.1
      ...
      ;;
    teacher_z_b075_g2_w01_s01)
      method_env=(
        ZERO_INIT_DELTA_HEAD=1
        RESPONSE_BASE_LOGIT_SCALE=0.75
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=64
        RESPONSE_DELTA_DETACH=1
    ...
    teacher_b075_g2_w05_s01)
      method_env=(
        ...
        DELTA_LOGIT_SCALE=0.1
        DELTA_LOGIT_LEARNABLE=1
        DELTA_TEACHER_LOSS_WEIGHT=0.5
        GRAPH_LOGIT_SCALE=2.0
        MSE_WEIGHT=0.25
      )
      ;;
    teacher_b075_g2_w01_s05)
      method_env=(
        RESPONSE_BASE_LOGIT_SCALE=0.75
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=64
    ...
    exprdrop020)
      method_env=(
        CONTROL_EXPRESSION_DROPOUT=0.20
        MSE_WEIGHT=0.25
      )
      ;;
    exprdrop030)
      method_env=(
        CONTROL_EXPRESSION_DROPOUT=0.30
        MSE_WEIGHT=0.25
      )
      ;;
    exprdrop020_learn_b075)
      method_env=(
        CONTROL_EXPRESSION_DROPOUT=0.20
        RESPONSE_BASE_LOGIT_SCALE=0.75
        RESPONSE_DELTA_MODE=summary
    ...
    zdelta_b0_g0_dim32)
      method_env=(
        ZERO_INIT_DELTA_HEAD=1
        RESPONSE_BASE_LOGIT_SCALE=0.0
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=32
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=1.0
        GRAPH_LOGIT_SCALE=0.0
        MSE_WEIGHT=0.25
      )
      ;;
    zdelta_b0_g05_dim32)
      method_env=(
        ...
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=1.0
        GRAPH_LOGIT_SCALE=0.5
        MSE_WEIGHT=0.25
      )
      ;;
    zdelta_b025_g05_dim32)
      method_env=(
        ZERO_INIT_DELTA_HEAD=1
        RESPONSE_BASE_LOGIT_SCALE=0.25
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=32
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=1.0
    ...
    zdelta_b05_g1_dim64)
      method_env=(
        ZERO_INIT_DELTA_HEAD=1
        RESPONSE_BASE_LOGIT_SCALE=0.5
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=64
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=1.0
        GRAPH_LOGIT_SCALE=1.0
        MSE_WEIGHT=0.25
      )
      ;;
    zdelta_b075_g2_dim64)
      method_env=(
        ZERO_INIT_DELTA_HEAD=1
        RESPONSE_BASE_LOGIT_SCALE=0.75
        RESPONSE_DELTA_MODE=summary
    ...
    zdelta_b05_g2_dim64)
      ...
      ;;
    delta512_b0_g0_d1_w1)
      method_env=(
        RESPONSE_BASE_LOGIT_SCALE=0.0
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=512
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=1.0
        GRAPH_LOGIT_SCALE=0.0
        MSE_WEIGHT=1.0
    ...
    delta512_b025_g05_d1_w1)
      ...
      ;;
    delta256_b05_g1_d1_w1)
      method_env=(
        RESPONSE_BASE_LOGIT_SCALE=0.5
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=256
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=1.0
        GRAPH_LOGIT_SCALE=1.0
        MSE_WEIGHT=1.0
    ...
    pretrain_base3)
      method_env=(
        MSE_PRETRAIN_EPOCHS=3
        MSE_PRETRAIN_BCE_WEIGHT=0.0
        MSE_WEIGHT=0.25
      )
      ;;
    pretrain_base5_bce02)
      method_env=(
        MSE_PRETRAIN_EPOCHS=5
        MSE_PRETRAIN_BCE_WEIGHT=0.2
        MSE_WEIGHT=0.25
      )
      ;;
    pretrain_delta_b1_g2_d05_pre3)
      method_env=(
        MSE_PRETRAIN_EPOCHS=3
        MSE_PRETRAIN_BCE_WEIGHT=0.0
        RESPONSE_BASE_LOGIT_SCALE=1.0
    ...
    pretrain_delta_b05_g2_d1_pre3)
      ...
      ;;
    pretrain_bridge_b05_g1_d1_pre5)
      method_env=(
        MSE_PRETRAIN_EPOCHS=5
        MSE_PRETRAIN_BCE_WEIGHT=0.1
        RESPONSE_BASE_LOGIT_SCALE=0.5
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=64
        RESPONSE_DELTA_DETACH=1
    ...
    bridge_b025_g05_d1_dim32)
      ...
      ;;
    bridge_b0_g1_d2_dim64)
      method_env=(
        RESPONSE_BASE_LOGIT_SCALE=0.0
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=64
        RESPONSE_DELTA_DETACH=1
        DELTA_LOGIT_SCALE=2.0
        GRAPH_LOGIT_SCALE=1.0
        MSE_TARGET_MODE=all
        MSE_WEIGHT=0.25
      )
      ;;
    bridge_pdi_b0_g05_d1)
      method_env=(
        RESPONSE_BASE_LOGIT_SCALE=0.0
        RESPONSE_DELTA_MODE=summary
        RESPONSE_DELTA_DIM=32
