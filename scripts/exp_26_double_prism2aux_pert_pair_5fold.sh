...
EXPERIMENT_SET_NAME="double_prism2aux_pert_pair_5fold"
...
ptv3_print_settings "Baseline4 double-drug 5-fold split with PRISM2-filtered single auxiliary rows"
ptv3_run_preflight

for fold in "${FOLD_LIST[@]}"; do
  ptv3_train "${EXP_PREFIX}_double_prism2aux_pert_pair_fold${fold}" \
    ptv3_main_doubledrug_prism2aux "pert_id_5fold_fold${fold}" synergy \
