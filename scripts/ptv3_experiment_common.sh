...
ptv3_print_settings() {
  ...
  echo "[settings] RESPONSE_DELTA_MODE=${RESPONSE_DELTA_MODE}; RESPONSE_DELTA_DIM=${RESPONSE_DELTA_DIM}; RESPONSE_DELTA_DETACH=${RESPONSE_DELTA_DETACH}; DELTA_LOGIT_SCALE=${DELTA_LOGIT_SCALE}"
  ...
  echo "[settings] MSE_WEIGHT_SCHEDULE=${MSE_WEIGHT_SCHEDULE}; MSE_DECAY_START_EPOCH_FRAC=${MSE_DECAY_START_EPOCH_FRAC}; MSE_FINAL_WEIGHT_MULTIPLIER=${MSE_FINAL_WEIGHT_MULTIPLIER}"
