...
ptv3_print_settings() {
  ...
  echo "[settings] RANKING_LOSS_WEIGHT=${RANKING_LOSS_WEIGHT}; RANKING_LOSS_GROUP_FIELD=${RANKING_LOSS_GROUP_FIELD}; DELTA_TEACHER_LOSS_WEIGHT=${DELTA_TEACHER_LOSS_WEIGHT}; CELL_PRIOR_MODE=${CELL_PRIOR_MODE}; CELL_PRIOR_LOGIT_SCALE=${CELL_PRIOR_LOGIT_SCALE}; CELL_PRIOR_FIXED_LOGIT_SCALE=${CELL_PRIOR_FIXED_LOGIT_SCALE}"
  echo "[settings] CELL_TYPE_LLM_MODE=${CELL_TYPE_LLM_MODE}; CELL_TYPE_LLM_EMBEDDING_PATH=${CELL_TYPE_LLM_EMBEDDING_PATH:-default}"
