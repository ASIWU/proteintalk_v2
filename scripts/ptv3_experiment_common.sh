...
ptv3_print_settings() {
  ...
  echo "[settings] CELL_PAIR_FILM_SCALE=${CELL_PAIR_FILM_SCALE}; RANKING_LOSS_WEIGHT=${RANKING_LOSS_WEIGHT}; RANKING_LOSS_GROUP_FIELD=${RANKING_LOSS_GROUP_FIELD}; CELL_PRIOR_MODE=${CELL_PRIOR_MODE}; CELL_PRIOR_LOGIT_SCALE=${CELL_PRIOR_LOGIT_SCALE}; CELL_PRIOR_FIXED_LOGIT_SCALE=${CELL_PRIOR_FIXED_LOGIT_SCALE}"
