...
EXP_PREFIX="${EXP_PREFIX:-20260513_single_no_mse_5fold}" \
...
EXP_PREFIX="${EXP_PREFIX:-20260513_single_cell_type_5fold}" \
LOG_TO_WANDB="${LOG_TO_WANDB:-1}" \
FOLDS="${FOLDS:-0 1 2 3 4}" \
MAX_EPOCHS="${MAX_EPOCHS:-100}" \
LEARNING_RATE="${LEARNING_RATE:-1e-4}" \
...
EXP_PREFIX="${EXP_PREFIX:-20260513_single_cell_5fold}" \
LOG_TO_WANDB="${LOG_TO_WANDB:-1}" \
FOLDS="${FOLDS:-0 1 2 3 4}" \
MAX_EPOCHS="${MAX_EPOCHS:-100}" \
LEARNING_RATE="${LEARNING_RATE:-1e-4}" \
...
EXP_PREFIX="${EXP_PREFIX:-20260513_double_pert_pair_5fold}" \
LOG_TO_WANDB="${LOG_TO_WANDB:-1}" \
FOLDS="${FOLDS:-0 1 2 3 4}" \
MAX_EPOCHS="${MAX_EPOCHS:-100}" \
LEARNING_RATE="${LEARNING_RATE:-1e-4}" \
...
EXP_PREFIX="${EXP_PREFIX:-20260513_extra_double_all_train_infer}" \
LOG_TO_WANDB="${LOG_TO_WANDB:-1}" \
...
BEST_CKPT_METRIC="${BEST_CKPT_METRIC:-loss2}" \
BATCH_SIZE="${BATCH_SIZE:-64}" \
REFERENCE_5FOLD_CKPT_PATH="${REFERENCE_5FOLD_CKPT_PATH:-checkpoints/20260513_double_pert_pair_5fold}" \
...
EXP_PREFIX="${EXP_PREFIX:-20260513_single_no_pdi_5fold}" \
LOG_TO_WANDB="${LOG_TO_WANDB:-1}" \
FOLDS="${FOLDS:-0 1 2 3 4}" \
MAX_EPOCHS="${MAX_EPOCHS:-100}" \
LEARNING_RATE="${LEARNING_RATE:-1e-4}" \
